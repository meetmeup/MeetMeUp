...
#define ALERT_VIEW_HEIGHT 60
#define ALERT_VIEW_COLOR [UIColor colorWithRed:250.0f/255.0f green:63.0f/255.0f blue:82.0f/255.0f alpha:1.0f]
...
@interface AlertViewStillCreator ()
{
    UIView *alertView;
}
...
@implementation AlertViewStillCreator
